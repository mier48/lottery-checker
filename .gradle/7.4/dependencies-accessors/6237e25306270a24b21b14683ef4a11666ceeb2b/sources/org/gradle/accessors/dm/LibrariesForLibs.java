...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class BundleAccessors extends BundleFactory {
        private final AndroidBundleAccessors baccForAndroidBundleAccessors = new AndroidBundleAccessors(providers, config);
        private final AndroidxBundleAccessors baccForAndroidxBundleAccessors = new AndroidxBundleAccessors(providers, config);
        private final ComBundleAccessors baccForComBundleAccessors = new ComBundleAccessors(providers, config);
    ...
    public static class AndroidBundleAccessors extends BundleFactory {
        ...
        public AndroidBundleAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
    ...
    public static class ComBundleAccessors extends BundleFactory {
        private final ComFirebaseBundleAccessors baccForComFirebaseBundleAccessors = new ComFirebaseBundleAccessors(providers, config);
        private final ComSquareupBundleAccessors baccForComSquareupBundleAccessors = new ComSquareupBundleAccessors(providers, config);

        public ComBundleAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
    ...
    public static class ComFirebaseBundleAccessors extends BundleFactory {
        ...
        public ComFirebaseBundleAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
    ...
    public static class ComSquareupBundleAccessors extends BundleFactory {
        ...
        public ComSquareupBundleAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
    ...
    public static class ComGithubPluginAccessors extends PluginFactory {
        ...
        private final ComGithubRzabiniPluginAccessors baccForComGithubRzabiniPluginAccessors = new ComGithubRzabiniPluginAccessors(providers, config);
        ...
        /**
         * Returns the group of bundles at plugins.com.github.rzabini
         */
        public ComGithubRzabiniPluginAccessors getRzabini() { return baccForComGithubRzabiniPluginAccessors; }
    ...
    public static class ComGithubRzabiniPluginAccessors extends PluginFactory {
        private final ComGithubRzabiniGradlePluginAccessors baccForComGithubRzabiniGradlePluginAccessors = new ComGithubRzabiniGradlePluginAccessors(providers, config);

        public ComGithubRzabiniPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of bundles at plugins.com.github.rzabini.gradle
         */
        public ComGithubRzabiniGradlePluginAccessors getGradle() { return baccForComGithubRzabiniGradlePluginAccessors; }
